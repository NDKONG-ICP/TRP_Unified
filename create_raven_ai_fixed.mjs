#!/usr/bin/env node
/**
 * Create raven_ai canister - using exact working pattern from deploy_working_final.mjs
 */
...
async function main() {
  console.log('🚀 Creating raven_ai canister');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
  ...
  try {
    ...
    const canisterId = await createCanisterViaWallet(agent, WALLET_ID, 600_000_000_000);
